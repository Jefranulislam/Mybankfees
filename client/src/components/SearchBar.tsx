    ...
    <div className="relative w-full max-w-2xl mx-auto" ref={searchRef}>
      <div className="relative">
        ...
        <input
          ...
          className="w-full pl-12 pr-12 py-4 text-lg border-2 border-gray-200 rounded-full focus:outline-none text-gray-800 focus:border-blue-500 focus:shadow-lg transition-all duration-200 bg-white"
        />
        {searchTerm && (
          <button
            onClick={clearSearch}
