...
import { ArrowLeft, Building2, Globe, MapPin, Calendar, Users, CreditCard, Calculator } from 'lucide-react';
import { bangladeshiBanks } from '../data/banks';
import { calculateCharges, calculateCustomCharges, formatCurrency } from '../utils/calculations';
import { UserCalculation } from '../types/bank';
...
export const BankDetailsPage: React.FC = () => {
  ...
  const bank = bangladeshiBanks.find(b => b.id === id);
    ...
    return (
      <div className="min-h-screen bg-gray-50 flex items-center justify-center">
        <div className="text-center">
          ...
          <h2 className="text-2xl font-bold text-gray-700 mb-2">Bank Not Found</h2>
          <p className="text-gray-500 mb-4">The requested bank could not be found.</p>
          <button
            onClick={() => navigate('/')}
          ...
          <div className="lg:col-span-1">
            ...
            <div className="bg-white rounded-lg shadow-md border border-gray-200 p-6">
              ...
              <div className="space-y-2">
                {bank.accountTypes.map((accountType) => (
                  <button
                    ...
                    <div>
                      ...
                      <div className="space-y-2 text-sm">
                        ...
                        <div className="flex justify-between">
                          ...
                          <span className="font-medium">{formatCurrency(selectedAccount.neftFee)}</span>
                        </div>
                        <div className="flex justify-between">
